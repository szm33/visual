...
namespace Zadanie1._0
{
    ...
    public class DodanieKsiazkiZdarzenie: Zdarzenie
    {
        ...
        public static string Serialize(DodanieKsiazkiZdarzenie z, ObjectIDGenerator generator)
        {
        ...
        public static Zdarzenie Deserialize(List<string> pole, Dictionary<string, object> obj)
        {
            ...
            {
                pole.RemoveAt(0);
                Zdarzenie z = new DodanieKsiazkiZdarzenie(Wykaz.Deserialize(pole, obj), OpisStanu.Deserialize(pole, obj), new DateTime(Int32.Parse(pole[0]), Int32.Parse(pole[1]), Int32.Parse(pole[2])), Int32.Parse(pole[3]));
                obj.Add(pole[4], z);
